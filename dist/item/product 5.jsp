...
<body>
    ...
    <div class="background1" style="height:100%;padding-bottom: 600px;" >
        <br><br><br><br><br><br>    
    <div class="M1"> <img src="../img/no5.png" width="450px"> </div>
    <div class="M2">
     <h2>【牛筋片】</h2><br>	
      <p>📯0添加任何色素香料，使用100%鮮食等級肉品製作<br>
        ...
        【津津有味-牛筋片】(狗狗專用)<br>
        重量：40克<br>
        口感較有嚼勁、非常耐咬，能夠讓狗狗發洩舒緩緊張和焦躁情緒，<br>
        同時具有潔牙效果哦！<br>
        <br>
        【寵食小知識】<br>
        嚼嚼嚴選新鮮健康低脂牛筋片，製程中不另外添加任何化學複方，未使用任何<br>
        添加物、色素、防腐劑，確保營養不流失，就是要給毛孩吃得美味天然又健康！<br>
        <br>
        牛筋有豐富的膠原蛋白、膠質、不含膽固醇，能夠補充肌膚與骨骼營養，在經<br>
        過低溫烘焙後口感是Q彈有韌性，很耐嚼耐肯可以讓狗狗玩很久，是最天然的<br>潔牙骨！<br>
        <br>
        ■ 注意事項 ■ <br>
