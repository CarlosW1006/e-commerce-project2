...
<body>
    ...
    <div class="background1" style="height:100%;padding-bottom: 600px;" >
        <br><br><br><br><br><br>    
    <div class="M1"> <img src="../img/no3.png" width="450px"> </div>
    <div class="M2">
     <h2>【雞胗片】</h2><br>	
     <p>📯0添加任何色素香料，使用100%鮮食等級肉品製作<br>
        ...
        重量：50克<br>
        (貓咪狗狗都可食用)<br>
        低熱量、低脂肪、低膽固醇！ 富含鐵質.動物膠質，能增強脾胃功能。<br>
        <br>
        【寵食小知識】<br>
        嚼嚼嚴選新鮮雞珍，製程中不另外添加任何化學複方，未使用任何添加物、色<br>素、防腐劑，確保營養不流失，就是要給毛孩吃得美味天然又健康！<br>
        <br>
        雞胗中含有維生素A、E，脂肪和熱量都很低，同時也是補鐵的最佳食品，烘乾<br>之後口感香香脆脆 ，香氣超難抗拒的是狗狗的最愛！<br>
        <br>
        ■ 注意事項 ■ <br>
        1. 為避免毛孩食用時噎到喉嚨，請依毛孩們的體型大小，撥開後餵食。<br>
        2. 本產品顏色可能深淺不一，其色澤差異屬於本身食材及烹調自然現象<br>
        3. 開封後關緊封口並建議冷藏，儘速食用完畢。<br>
        4.內置脫氧劑請勿食用。 </p><br><br><br>
    </div>
        <!--購買鍵在這!!!-->
        <br>
        <br>
